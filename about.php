      ...
      <div class="row">
        <div class="col-md-6">
          <div class="row">
            <div class="card-body">
              <h4>Kontak kami</h4>
              <p class="card-text"><p>PT. temancoffe</p>
              Jl. Pondok pinang Anggrek,Pesanggrahan , JAKARTA SELATAN - DKI JAKARTA
              Indonesia (12330) </p>

              <p>Call/SMS/WA : 087841287511
                E-mail : temancoffe@gmail.com </p>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6">
              <div class="row">
                <div class="card-body">
                  <h4>Media Sosial</h4>
                  <p class="card-text">
                    <p><img src="assets/img/instagram.png" width="50px" height="50px"> <a href="Instagram.com/temancoffe.official">Instagram.com/temancoffe.official</a></p>

                    <p><img src="assets/img/facebook.png" width="50px" height="50px"> <a href="facebook.com/Teman Coffe"> facebook.com/Teman Coffe</a></p>

                    <p><img src="assets/img/twitter.png" width="50px" height="50px"> <a href="Twitter.com/temancoffe.official"> Twitter.com/temancoffe.official</a></p>

                    <p><img src="assets/img/youtube.png" width="50px" height="50px"><a href="Teman Coffe"> Teman Coffe</a></p>   
                  </div>
                </div>
              </div>
            </div>
